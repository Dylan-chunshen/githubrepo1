...
var t=$(_174);
return $.extend({},$.parser.parseOptions(_174,["url","method","nullValue","nullText",{hasNullOpt:"boolean"},{checkbox:"boolean",cascadeCheck:"boolean",onlyLeafCheck:"boolean"},{animate:"boolean",lines:"boolean",dnd:"boolean"}]));
};
$.fn.tree.defaults={isFirstUrlLoad:true,hasNullOpt:false,nullValue:"",nullText:"--请选择--",url:null,method:"post",animate:false,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,dnd:false,data:null,loader:function(_175,_176,_177){
...
var _73b=$("<input type=\"hidden\" name=\""+name+"\" class=\"combo-value\">").appendTo(_73a);
if(name){
_73b.attr("name",name);
}
_73b.val(_738[i]);
...
if(_738.length==0)
	$("<input type=\"hidden\" name=\""+name+"\" class=\"combo-value\">").appendTo(_73a);
...
if(data[i][opts.valueField]==_75e||''==_75e){
opts.onSelect.call(_75d,''==_75e?null:data[i]);
if(''==_75e){
	$(_75d).next().find("input.combo-value").val("");
	$(_75d).next().find("input.combo-text").val();
}
return;
}
}
...
_76e.empty();
var nullItem=$("<div class=\"combobox-item\"></div>").appendTo(_76e);
