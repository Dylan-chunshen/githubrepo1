...
for(var i=0;_3a7!=null&&i<_3a7.length;i++){
...
_606.empty();
var nullItem=$("<div class=\"combobox-item\"></div>").appendTo(_606);
nullItem.attr("value",opts.nullValue);
nullItem.html(opts.nullText);
for(var i=0;i<data.length;i++){
...
var t=$(_61a);
return $.extend({},$.fn.combo.parseOptions(_61a),{valueField:t.attr("valueField"),textField:t.attr("textField"),mode:t.attr("mode"),url:t.attr("url"),nullValue:t.attr("nullValue"),nullText:t.attr("nullText")});
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",nullValue:"",nullText:"--ÇëÑ¡Ôñ--",mode:"local",url:null,data:null,keyHandler:{up:function(){
_5ea(this);
},down:function(){
_5f0(this);
},enter:function(){
